...
//			broker.bindCloudletsToVmsSimple();
	...
	public static void minmin (List<Cloudlet> list)
	{
		
	}
	
	public static void maxMin (List<Cloudlet> list)
	{
		
	}
	
	public static void sufferage (List<Cloudlet> list)
	{
