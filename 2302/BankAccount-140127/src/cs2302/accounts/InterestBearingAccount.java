...
public class InterestBearingAccount extends Account {
	...
	private double minMonthlyBalance;
	
	public double getMinMonthlyBalance() {
		return minMonthlyBalance;
	}
	...
	public void addMonthlyInterest() {
		deposit(minMonthlyBalance*annualInterestRate/12);
	}
	
	@Override
	public void endOfMonthProcess() {
		addMonthlyInterest();
		minMonthlyBalance = getBalance();
	}
		
	@Override
	public void withdraw(double amount) {
		super.withdraw(amount);
		if(getBalance() > 0 && getBalance() <= minMonthlyBalance) {
			minMonthlyBalance = getBalance();
	}
	}
